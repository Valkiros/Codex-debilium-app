...
export const ArmesTable: React.FC<ArmesTableProps> = React.memo(({ items, onItemsChange, referenceOptions, defaultItem, characterForce, onRemove }) => {
                                ...
                                <tr key={item.uid} className="border-b border-leather-light/30 hover:bg-leather/5">
                                    ...
                                    <td className="p-2 text-center text-ink-light font-mono">
                                        {(() => {
                                            ...
                                            const type = refItem?.type || refItem?.category || item.equipement_type || '';
                                    ...
                                    <td className="p-2 font-bold text-leather">
                                        {(() => {
                                            const degats = refItem?.degats || ''; // Use mapped value
